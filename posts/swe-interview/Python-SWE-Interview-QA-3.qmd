...
> For foundational Python topics, see [Python SWE Interview QA - 1](/posts/python-swe-interview/Python-SWE-Interview-QA-1.html). For advanced internals (async, metaclasses, descriptors), see [Python SWE Interview QA - 2](/posts/python-swe-interview/Python-SWE-Interview-QA-2.html).
...
- **Advanced internals:** [Python SWE Interview QA - 2](/posts/python-swe-interview/Python-SWE-Interview-QA-2.html)
