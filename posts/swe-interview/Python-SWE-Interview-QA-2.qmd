...
> For foundational Python topics (GIL, decorators, generators, etc.), see [Python SWE Interview QA - 1](/posts/python-swe-interview/Python-SWE-Interview-QA-1.html). For ML/AI interview content, see [ML Interview QA - 1](/posts/ml-interview/ML-Interview-QA-1.html) and [LLM Interview QA - 1](/posts/llm-interview/LLM-Interview-QA-1.html).
...
- **Python fundamentals:** [Python SWE Interview QA - 1](/posts/python-swe-interview/Python-SWE-Interview-QA-1.html)
