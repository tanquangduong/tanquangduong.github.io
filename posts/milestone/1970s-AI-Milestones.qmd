...
description: "The First AI Winter — when high expectations collided with harsh realities, and a new paradigm quietly took root"
...
- See the milestones that set the stage — [1950s–1960s AI Milestones](/posts/milestone/1950s-1960s-AI-Milestones.html)
- From expert systems to modern knowledge engineering — see [Prompt Engineering vs Context Engineering](/posts/llm/Prompt-Engineering-vs-Context-Engineering.html)
- How modern AI escaped the winter — see [Pre-training LLMs from Scratch](/posts/llm/Pre-training-LLMs-from-Scratch.html)
- The revival of neural networks that Perceptrons froze — see [Training LLMs for Reasoning](/posts/llm/Training-LLMs-for-Reasoning.html)
- Modern AI serving at scale — see [Scaling LLM Serving for Enterprise Production](/posts/llm/Scaling-LLM-Serving-for-Enterprise-Production.html)
