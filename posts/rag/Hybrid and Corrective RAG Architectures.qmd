...
> For monitoring tools, see [RAG in Production: Scaling, Caching, and Observability](/posts/rag/RAG%20in%20Production%20Scaling%20Caching%20and%20Observability.html).
...
- Measure the impact of **Self-RAG**, **CRAG**, and **Adaptive RAG** with [RAG evaluation metrics](/posts/rag/Evaluating%20RAG%20Systems.html).
- Fine-tune the retrieval evaluator and grounding checker using [component fine-tuning techniques](/posts/rag/Fine-tuning%20RAG%20Components%20Embeddings%20Retrievers%20and%20Generators.html).
- Extend corrective pipelines with [multimodal retrieval](/posts/rag/Retrieval%20over%20Images%20Tables%20and%20PDFs.html) for documents with images and tables.
- Deploy corrective RAG at scale with [production caching, routing, and observability](/posts/rag/RAG%20in%20Production%20Scaling%20Caching%20and%20Observability.html).
