...
description: "Selecting, fine-tuning, and combining embedding models with cross-encoder rerankers for production retrieval pipelines"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/rag/embedding_models_and_reranking_for_rag.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/rag/embedding_models_and_reranking_for_rag.ipynb" style="display:none"></div>


![Embedding models and cross-encoder reranking for RAG retrieval](/images/rag/embedding-reranking-rag-300px.png){fig-align="center" width=300}
...
> For serving the LLM backbone, see [Scaling LLM Serving for Enterprise Production](/posts/llm/Scaling-LLM-Serving-for-Enterprise-Production.html). For running models locally, see [Run LLM locally with Ollama](/posts/llm/Run-LLM-locally-with-Ollama.html). For observability, see [Observability for Multi-Turn LLM Conversations](/posts/llm/Observability-for-Multi-Turn-LLM-Conversations.html). For guardrails, see [Guardrails for LLM Applications with Giskard](/posts/llm/Guardrails-for-LLM-Applications-with-Giskard.html).
...
- Improve retrieval input quality with [advanced chunking strategies](/posts/rag/Advanced-Chunking-Strategies-for-RAG.html) — embedding performance depends heavily on chunk design.
- Add **graph-based retrieval** with [GraphRAG](/posts/rag/GraphRAG-Knowledge-Graphs-Meet-Retrieval-Augmented-Generation.html) for multi-hop reasoning over entity relationships.
- Evaluate your embedding and reranking pipeline with [RAGAS and DeepEval](/posts/rag/Evaluating-RAG-Systems.html) to measure real-world retrieval gains.
- Fine-tune your embeddings and rerankers on domain data using techniques from [Fine-tuning RAG Components](/posts/rag/Fine-tuning-RAG-Components-Embeddings-Retrievers-and-Generators.html).
