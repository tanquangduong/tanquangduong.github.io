...
- Add [evaluation metrics](/posts/rag/Evaluating%20RAG%20Systems.html) to measure graph retrieval quality against standard vector search.
- Combine graph reasoning with [agentic RAG](/posts/rag/Agentic%20RAG%20When%20Retrieval%20Needs%20Reasoning.html) to let the agent decide when to query the graph vs. the vector store.
- Handle **multimodal documents** with [image and table retrieval](/posts/rag/Retrieval%20over%20Images%20Tables%20and%20PDFs.html) alongside graph-based knowledge.
- Scale your GraphRAG pipeline to production with [caching, observability, and cost optimization](/posts/rag/RAG%20in%20Production%20Scaling%20Caching%20and%20Observability.html).
