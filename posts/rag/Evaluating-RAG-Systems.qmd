...
description: "Metrics, frameworks, and automated evaluation for retrieval quality, generation faithfulness, and end-to-end RAG performance with RAGAS, DeepEval, and LangSmith"
...
> For more on hallucination mitigation, see [Guardrails for LLM Applications with Giskard](/posts/llm/Guardrails-for-LLM-Applications-with-Giskard.html).
...
4. **Iterate**: Evaluation should run on every pipeline change. Low `context_recall`? Improve your [chunking strategy](/posts/rag/Advanced-Chunking-Strategies-for-RAG.html) or [embedding model](/posts/rag/Embedding-Models-and-Reranking-for-RAG.html). Low `faithfulness`? Tune your prompt or add a [reranker](/posts/rag/Embedding-Models-and-Reranking-for-RAG.html).
...
- Improve retrieval scores by tuning your [chunking strategy](/posts/rag/Advanced-Chunking-Strategies-for-RAG.html) and [embedding model](/posts/rag/Embedding-Models-and-Reranking-for-RAG.html).
- Address low faithfulness by adding [corrective RAG](/posts/rag/Hybrid-and-Corrective-RAG-Architectures.html) patterns like **CRAG** and **Self-RAG**.
- Fine-tune underperforming components using techniques from [Fine-tuning RAG Components](/posts/rag/Fine-tuning-RAG-Components-Embeddings-Retrievers-and-Generators.html).
- Set up continuous evaluation in production with [observability and monitoring](/posts/rag/RAG-in-Production-Scaling-Caching-and-Observability.html).
