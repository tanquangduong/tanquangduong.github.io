...
> For setting up Ollama, see [Run LLM locally with Ollama](/posts/llm/Run-LLM-locally-with-Ollama.html).
...
> For more on prompt design, see [Prompt Engineering vs Context Engineering](/posts/llm/Prompt-Engineering-vs-Context-Engineering.html).
...
- Add **hybrid search** and [reranking](/posts/rag/Embedding-Models-and-Reranking-for-RAG.html) for production-quality retrieval.
- Implement **evaluation** with [RAGAS](/posts/rag/Evaluating-RAG-Systems.html) to measure retrieval and generation quality.
- Explore [GraphRAG](/posts/rag/GraphRAG-Knowledge-Graphs-Meet-Retrieval-Augmented-Generation.html) for knowledge-graph-augmented retrieval.
- Build [agentic RAG](/posts/rag/Agentic-RAG-When-Retrieval-Needs-Reasoning.html) with query planning and self-reflection.
- Try [multimodal RAG](/posts/rag/Retrieval-over-Images-Tables-and-PDFs.html) with images, tables, and PDFs using **LlamaParse**.
