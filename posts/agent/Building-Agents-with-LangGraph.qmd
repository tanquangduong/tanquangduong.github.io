...
description: "State machines, conditional routing, cycles, and human-in-the-loop checkpoints for retrieval workflows"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/agent/building_agents_with_langgraph.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/agent/building_agents_with_langgraph.ipynb" style="display:none"></div>


![LangGraph state machine with conditional routing and checkpoints](/images/agent/building-agents-langgraph-300px.png){fig-align="center" width=300}
...
- Understand the ReAct reasoning loop that LangGraph orchestrates with [Building a ReAct Agent from Scratch](/posts/agent/Building-a-ReAct-Agent-from-Scratch.html) — covers the Thought-Action-Observation cycle, parsing, and stopping conditions.
- Connect agents to SQL, APIs, and vector stores with [Tool Use and Function Calling for Retrieval Agents](/posts/agent/Tool-Use-and-Function-Calling-for-Retrieval-Agents.html) — from OpenAI function calling to MCP.
- Build the retrieval pipelines these agents call with [Building a RAG Pipeline from Scratch](/posts/rag/Building-a-RAG-Pipeline-from-Scratch.html) — chunking, embedding, retrieval, and generation.
- Add self-correcting retrieval with [Hybrid and Corrective RAG Architectures](/posts/rag/Hybrid-and-Corrective-RAG-Architectures.html) — the patterns behind the corrective RAG graph in this article.
- Implement agent-driven retrieval routing with [Agentic RAG: When Retrieval Needs Reasoning](/posts/rag/Agentic-RAG-When-Retrieval-Needs-Reasoning.html).
...
- Add safety guardrails with [Guardrails for LLM Applications with Giskard](/posts/llm/Guardrails-for-LLM-Applications-with-Giskard.html).
