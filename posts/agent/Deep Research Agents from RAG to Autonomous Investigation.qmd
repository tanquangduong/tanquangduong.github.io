...
**Deep research agents** close this gap. They extend the [ReAct](/posts/agent/Building%20a%20ReAct%20Agent%20from%20Scratch.html) loop into a full research workflow: plan what to investigate, search iteratively across the web and local documents, reflect on whether findings are sufficient, triangulate claims across multiple sources, and compile everything into a comprehensive report.
...
- Build the foundational agent loop with [Building a ReAct Agent from Scratch](/posts/agent/Building%20a%20ReAct%20Agent%20from%20Scratch.html) — the Thought-Action-Observation pattern that underpins deep research agents.
- Add [tool calling and function calling](/posts/agent/Tool%20Use%20and%20Function%20Calling%20for%20Retrieval%20Agents.html) for structured interactions with search APIs and retrieval tools.
- Design the state graph backbone with [Building Agents with LangGraph](/posts/agent/Building%20Agents%20with%20LangGraph.html) — nodes, edges, and conditional routing.
- Orchestrate multiple research sub-agents using [Multi-Agent RAG Orchestration Patterns](/posts/agent/Multi-Agent%20RAG%20Orchestration%20Patterns.html).
- Add persistent context across research sessions with [Memory Systems for Long-Running Retrieval Agents](/posts/agent/Memory%20Systems%20for%20Long-Running%20Retrieval%20Agents.html).
- Decompose complex research questions with [Planning and Query Decomposition for Complex Retrieval](/posts/agent/Planning%20and%20Query%20Decomposition%20for%20Complex%20Retrieval.html).
- Ground your research agent in domain documents with [Building a RAG Pipeline from Scratch](/posts/rag/Building%20a%20RAG%20Pipeline%20from%20Scratch.html) and evaluate result quality with [Evaluating RAG Systems](/posts/rag/Evaluating%20RAG%20Systems.html).
