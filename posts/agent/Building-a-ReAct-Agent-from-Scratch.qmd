...
description: "Implementing the Reason-Act loop with tool calling, observation parsing, and stopping conditions in LangGraph and LlamaIndex"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/agent/building_a_react_agent_from_scratch.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/agent/building_a_react_agent_from_scratch.ipynb" style="display:none"></div>


![ReAct agent thought-action-observation loop architecture](/images/agent/react-agent-from-scratch-300px.png){fig-align="center" width=300}
...
- Connect your ReAct agent to multiple retrieval sources with [Agentic RAG](/posts/rag/Agentic-RAG-When-Retrieval-Needs-Reasoning.html) patterns for query routing, self-reflection, and iterative refinement.
- Add structured knowledge retrieval with [GraphRAG](/posts/rag/GraphRAG-Knowledge-Graphs-Meet-Retrieval-Augmented-Generation.html) as a tool for entity-relationship queries.
- Implement [guardrails](/posts/llm/Guardrails-for-LLM-Applications-with-Giskard.html) to validate tool inputs and agent outputs before they reach users.
- Monitor agent behavior in production with [observability](/posts/llm/Observability-for-Multi-Turn-LLM-Conversations.html) tools that trace every Thought-Action-Observation step.
