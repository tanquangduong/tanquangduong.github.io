...
description: "Conversation buffers, working scratchpads, episodic vector recall, and cross-agent memory sharing for persistent agent state"
...
![Agent memory systems: conversation buffer, episodic, and semantic recall](/images/agent/memory-systems-retrieval-agents-300px.png){fig-align="center" width=300}
