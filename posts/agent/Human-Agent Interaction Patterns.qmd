...
- [Building a ReAct Agent from Scratch](/posts/agent/Building%20a%20ReAct%20Agent%20from%20Scratch.html) — The Thought-Action-Observation loop that makes each agent step inspectable for human oversight.
- [Building Agents with LangGraph](/posts/agent/Building%20Agents%20with%20LangGraph.html) — LangGraph's `interrupt()` and checkpointers provide the infrastructure for HITL and HOTL patterns.
- [Guardrails and Safety for Autonomous Retrieval Agents](/posts/agent/Guardrails%20and%20Safety%20for%20Autonomous%20Retrieval%20Agents.html) — Guardrails are the policy enforcement mechanism for Human-over-the-Loop agents.
- [Design Patterns for AI Agents](/posts/agent/Design%20Patterns%20for%20AI%20Agents.html) — Architectural patterns like Evaluator-Optimizer and Orchestrator-Workers that combine with these oversight patterns.
- [Evaluating and Debugging AI Agents](/posts/agent/Evaluating%20and%20Debugging%20AI%20Agents.html) — Measuring agent error rates is essential for deciding when to graduate to more autonomy.
- [Deploying Retrieval Agents in Production](/posts/agent/Deploying%20Retrieval%20Agents%20in%20Production.html) — Production deployment patterns including monitoring dashboards used in Human-on-the-Loop setups.
