...
description: "End-to-end guide: deploy and serve LLMs at scale with vLLM for high-throughput, low-latency inference"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/deploying_and_serving_llm_with_vllm.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/deploying_and_serving_llm_with_vllm.ipynb" style="display:none"></div>


![High-throughput LLM serving with vLLM inference engine](/images/llm/vllm-deploying-serving-300px.png){fig-align="center" width=300}
