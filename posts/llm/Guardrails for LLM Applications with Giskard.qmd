...
> For deploying and serving the LLM itself, see [Deploying and Serving LLM with vLLM](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20vLLM.html). For scaling to production, see [Scaling LLM Serving for Enterprise Production](/posts/llm/Scaling%20LLM%20Serving%20for%20Enterprise%20Production.html). For alignment training that reduces harmful outputs at the model level, see [Post-Training LLMs for Human Alignment](/posts/llm/Post-Training%20LLMs%20for%20Human%20Alignment.html).
...
- **Align your model first:** See [Post-Training LLMs for Human Alignment](/posts/llm/Post-Training%20LLMs%20for%20Human%20Alignment.html) for RLHF and DPO techniques that reduce harmful outputs at the model level
- **Deploy and scale:** See [Scaling LLM Serving for Enterprise Production](/posts/llm/Scaling%20LLM%20Serving%20for%20Enterprise%20Production.html) for deploying guardrailed LLMs at scale with Kubernetes
- **Reduce model size for faster inference:** See [Quantization Methods for LLMs](/posts/llm/Quantization%20Methods%20for%20LLMs.html) for techniques that lower latency and memory requirements
