...
description: "End-to-end guide: fine-tune a small model on Hugging Face with Unsloth and deploy locally with Ollama"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/fine_tuning_llm_with_unsloth_and_serving_it_with_ollama.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/fine_tuning_llm_with_unsloth_and_serving_it_with_ollama.ipynb" style="display:none"></div>


![Fine-tuning LLMs with Unsloth and serving with Ollama](/images/llm/unsloth x ollama-300px.png){fig-align="center" width=300}
...
Read this article for more details: [Run LLM Locally with Ollama](https://tanquangduong.github.io/posts/llm/Run-LLM-locally-with-Ollama.html) 
