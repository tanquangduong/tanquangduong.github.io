...
> For fine-tuning an existing model, see [Fine-tuning an LLM with Unsloth and Serving with Ollama](/posts/llm/Fine-tuning%20LLM%20with%20Unsloth%20and%20serving%20it%20with%20Ollama.html). For post-training alignment, see [Post-Training LLMs for Human Alignment](/posts/llm/Post-Training%20LLMs%20for%20Human%20Alignment.html). For reasoning training, see [Training LLMs for Reasoning](/posts/llm/Training%20LLMs%20for%20Reasoning.html).
...
2. Follow with **SFT** on instruction data using [Unsloth](/posts/llm/Fine-tuning%20LLM%20with%20Unsloth%20and%20serving%20it%20with%20Ollama.html)
...
3. **Post-train** with [alignment techniques](/posts/llm/Post-Training%20LLMs%20for%20Human%20Alignment.html) (DPO/GRPO)
4. Add [reasoning capabilities](/posts/llm/Training%20LLMs%20for%20Reasoning.html) if needed
5. Deploy with [vLLM](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20vLLM.html) for production
...
> For the next steps after pretraining, see [Post-Training LLMs for Human Alignment](/posts/llm/Post-Training%20LLMs%20for%20Human%20Alignment.html) and [Training LLMs for Reasoning](/posts/llm/Training%20LLMs%20for%20Reasoning.html).
