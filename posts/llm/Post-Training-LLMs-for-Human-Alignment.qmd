...
description: "A practical comparison of SFT, RLHF, DPO, ORPO, KTO, and GRPO for aligning pretrained language models with human preferences"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/post_training_llms_for_human_alignment.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/post_training_llms_for_human_alignment.ipynb" style="display:none"></div>


![Post-training alignment methods: SFT, RLHF, DPO, ORPO, KTO, GRPO](/images/llm/post-training-human-aligment-300px.png){fig-align="center" width=300}
...
> For serving your aligned model, see [Run LLM locally with Ollama](/posts/llm/Run-LLM-locally-with-Ollama.html) or [Deploying and Serving LLM with vLLM](/posts/llm/Deploying-and-Serving-LLM-with-vLLM.html).
