...
> For guides on deploying and serving quantized models, see [Deploying and Serving LLM with Llama.cpp](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20Llama.cpp.html) (GGUF format) and [Deploying and Serving LLM with vLLM](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20vLLM.html) (AWQ/GPTQ support). To fine-tune a quantized model, see [Fine-tuning an LLM with Unsloth and Serving with Ollama](/posts/llm/Fine-tuning%20LLM%20with%20Unsloth%20and%20serving%20it%20with%20Ollama.html).
...
* **Enable edge/local deployment** with tools like [Ollama](/posts/llm/Run%20LLM%20locally%20with%20Ollama.html).
...
- Quantize your [fine-tuned model](/posts/llm/Fine-tuning%20LLM%20with%20Unsloth%20and%20serving%20it%20with%20Ollama.html) to GGUF for local deployment.
- Deploy a quantized model behind an API with [llama.cpp](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20Llama.cpp.html) or [vLLM](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20vLLM.html).
