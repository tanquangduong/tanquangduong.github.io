...
> If you are new to running LLMs locally, check out [Run LLM Locally with Ollama](/posts/llm/Run%20LLM%20locally%20with%20Ollama.html) for a beginner-friendly setup guide. For deploying models at scale, see [Deploying and Serving LLM with vLLM](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20vLLM.html) and [Deploying and Serving LLM with Llama.cpp](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20Llama.cpp.html).
...
- Combine decoding methods with [fine-tuned models](/posts/llm/Fine-tuning%20LLM%20with%20Unsloth%20and%20serving%20it%20with%20Ollama.html) for domain-specific generation.
- Serve your model locally with [Ollama](/posts/llm/Run%20LLM%20locally%20with%20Ollama.html) or [llama.cpp](/posts/llm/Deploying%20and%20Serving%20LLM%20with%20Llama.cpp.html) and control decoding via API parameters.
