...
> For the full pretraining pipeline (data collection, cleaning, tokenization), see [Pre-training LLMs from Scratch](/posts/llm/Pre-training-LLMs-from-Scratch.html). For post-training alignment, see [Post-Training LLMs for Human Alignment](/posts/llm/Post-Training-LLMs-for-Human-Alignment.html).
...
graph LR
    ...
    style Dense fill:#fff
    style Sparse fill:#fff
```
...
1. Start with **sparse upcycling** from a dense checkpoint (see [Pre-training LLMs from Scratch](/posts/llm/Pre-training-LLMs-from-Scratch.html))
2. Use the OLMoE or megablocks training pipeline
3. Fine-tune with **SFT → DPO** for instruction following
4. Deploy with [vLLM](/posts/llm/Deploying-and-Serving-LLM-with-vLLM.html) using expert parallelism
...
> For the complete pretraining pipeline, see [Pre-training LLMs from Scratch](/posts/llm/Pre-training-LLMs-from-Scratch.html). For alignment techniques, see [Post-Training LLMs for Human Alignment](/posts/llm/Post-Training-LLMs-for-Human-Alignment.html). For reasoning training, see [Training LLMs for Reasoning](/posts/llm/Training-LLMs-for-Reasoning.html).
