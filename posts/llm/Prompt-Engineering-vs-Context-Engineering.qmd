...
description: "From crafting single prompts to designing dynamic systems that give LLMs everything they need to succeed"
...
![Prompt engineering vs context engineering for LLM applications](/images/llm/prompt-vs-context-engineering-300px.png){fig-align="center" width=300}
...
- Deploy your LLM application with [vLLM](/posts/llm/Deploying-and-Serving-LLM-with-vLLM.html) or [llama.cpp](/posts/llm/Deploying-and-Serving-LLM-with-Llama.cpp.html).
- Compress models for efficient serving with [quantization techniques](/posts/llm/Quantization-Methods-for-LLMs.html).
- Run models locally with [Ollama](/posts/llm/Run-LLM-locally-with-Ollama.html) for private, zero-latency inference.
