...
description: "End-to-end guide: deploy and serve LLMs locally and at scale with llama.cpp for efficient CPU/GPU inference"
colab: <a href="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/deploying_and_serving_llm_with_llama_cpp.ipynb"><img src="/images/colab.png" alt="Open in Colab"></a>
...
<div id="notebook-link" data-url="https://colab.research.google.com/github/VectoringAI/ai-engineering/blob/main/llm/deploying_and_serving_llm_with_llama_cpp.ipynb" style="display:none"></div>


![Deploying and serving LLMs locally with llama.cpp](/images/llm/llama.cpp-300.png){fig-align="center" width=300}
...
graph TD
    ...
    style cpu fill:#6cc3d5,stroke:#fff,color:#fff
    style gpu fill:#56cc9d,stroke:#fff,color:#fff
```
